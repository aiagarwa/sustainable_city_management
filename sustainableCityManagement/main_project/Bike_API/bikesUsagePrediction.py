...
def predictBikesUsageTest(arrayOfUsagePerDay, predictDays=1, previous_days_to_consider = 4):
    # print(arrayOfUsagePerDay)
    X = []
    y = []
    # if len(arrayOfUsagePerDay) > previous_days_to_consider :
...
# arr = [22,27,21,27, 23]
# print(predictBikesUsageTest(arr))