...
class TestGraphValuesBike(TestCase):
    ...
    def test_graphvalue_call_locationbased(self):
        ...
        store_processed_bike_data_to_database.fetch_processed_data = MagicMock(
            return_value=mocked_result_historical)
        store_predicted_bike_data_to_database.fetch_predicted_data = MagicMock(
            return_value=mocked_result_predicted)
        ...
        result = fetch_bike_api_class.bikeapi(
            locations=False, store_processed_bike_data_to_database=store_processed_bike_data_to_database)
        print(result)
