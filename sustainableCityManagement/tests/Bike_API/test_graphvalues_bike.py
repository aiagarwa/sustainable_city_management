...
class TestGraphValuesBike(TestCase):
    ...
    def test_graphvalue_call_locationbased(self):
        ...
        store_processed_bike_data_to_database.fetch_processed_data = MagicMock(return_value=mocked_fetch_processed_data)
        store_processed_bike_data_to_database.fetch_predicted_data = MagicMock(return_value=mocked_fetch_predicted_data)
